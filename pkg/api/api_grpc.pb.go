...
func (c *adminClient) UserAdd(ctx context.Context, in *UserAddRequest, opts ...grpc.CallOption) (*UserAddResponse, error) {
	out := new(UserAddResponse)
	err := c.cc.Invoke(ctx, "/ozon.dev.homework1.api.Admin/UserAdd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) UserGet(ctx context.Context, in *UserGetRequest, opts ...grpc.CallOption) (*UserGetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ozon.dev.homework1.api.Admin/UserGet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) UserList(ctx context.Context, in *UserListRequest, opts ...grpc.CallOption) (*UserListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ozon.dev.homework1.api.Admin/UserList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) UserUpdate(ctx context.Context, in *UserUpdateRequest, opts ...grpc.CallOption) (*UserUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ozon.dev.homework1.api.Admin/UserUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) UserDelete(ctx context.Context, in *UserDeleteRequest, opts ...grpc.CallOption) (*UserDeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ozon.dev.homework1.api.Admin/UserDelete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAdminServer) UserAdd(context.Context, *UserAddRequest) (*UserAddResponse, error) {
...
func _Admin_UserAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.homework1.api.Admin/UserAdd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).UserAdd(ctx, req.(*UserAddRequest))
	}
...
func _Admin_UserGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.homework1.api.Admin/UserGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Admin_UserList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.homework1.api.Admin/UserList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Admin_UserUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.homework1.api.Admin/UserUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Admin_UserDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.homework1.api.Admin/UserDelete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Admin_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ozon.dev.homework1.api.Admin",
